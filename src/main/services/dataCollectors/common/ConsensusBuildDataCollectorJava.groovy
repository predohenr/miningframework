...
import services.dataCollectors.buildRequester.RequestBuildForRevisionDataCollector // IMPORT ADICIONADO
...
class ConsensusBuildDataCollectorJava implements DataCollector {
    ...
    private final List<String> tools = ["mergiraf", "mergiraf_semi", "mergiraf_semi_plus", "diff3", "s3m"]
