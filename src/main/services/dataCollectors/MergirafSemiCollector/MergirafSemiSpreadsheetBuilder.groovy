...
class MergirafSemiSpreadsheetBuilder {
    ...
    static {
        ...
        List<String> mergeIds = MergirafSemiMergeSummary.getMergeIds()
    ...
    static synchronized void updateSpreadsheet(Project project, MergeCommit mergeCommit, List<MergirafSemiMergeSummary> summaries) {
    ...
    private static String getSpreadsheetValuesLine(Project project, MergeCommit mergeCommit, MergirafSemiMergeSummary mergeSummary) {
        List<String> values = []
