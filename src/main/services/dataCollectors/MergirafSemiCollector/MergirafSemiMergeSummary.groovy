...
class MergirafSemiMergeSummary {
    ...
    static List<String> getMergeIds() {
        List<String> mergeIds = MergirafSemiMergesCollector.getMergeToolNames()
        mergeIds.add('actual')
        return mergeIds
    }
    ...
    private Map<String, Path> getMergePaths() {
        ...
        List<String> mergeToolNames = MergirafSemiMergesCollector.getMergeToolNames()
