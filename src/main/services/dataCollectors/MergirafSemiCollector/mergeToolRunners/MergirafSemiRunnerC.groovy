...
class MergirafSemiRunnerC extends MergeToolRunner {
    private static final Path MERGIRAF_PATH = Paths.get('dependencies/mergiraf-semi-c')

    MergirafSemiRunnerC() {
        this.mergeToolName = 'mergiraf-semi-c'
    }
